            ...
            try {
                switch (commandsArr[0]) {
                    case "EXIT":
                        ...
                        System.exit(0);
                    case "USEDRESSING":
                        shop.useDressingRoom(c);
                        break;
                    case "FREEUPDRESSING":
                        shop.freeUpDressingRoom();
                        break;
                    case "ADDCUSTOMERINSHOP":
                        shop.addCustomerInShop(c);
                        break;
                    ...
                    case "SHOWCUSTOMERARTICLES":
                        shop.showCustomerArticles(c);
                        break;
                    case "ADDARTICLEFORCUSTOMER":
                        shop.addArticleForCustomer(c, a);
                        break;
                    case "ADDARTICLEINSHOP":
                        shop.addArticleInShop(a);
                        break;
                    case "CUSTOMERBILL":
                        shop.moneySpentByCustomer(c);
                        break;
                    default:
                        System.out.println("WRONG COMMAND!");
                }
            }catch (NotEnoughArticlesException | TooManyCustomersException e) {
                e.printStackTrace();
            }
        }
    }
